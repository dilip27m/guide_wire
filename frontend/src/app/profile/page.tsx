            ...
            <div className="lg:col-span-5 flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-3">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 py-4 px-6 rounded-xl font-black uppercase tracking-widest text-sm text-slate-900 bg-white border-4 border-slate-900 shadow-[6px_6px_0px_0px_rgba(15,23,42,1)] hover:-translate-y-1 hover:shadow-[8px_8px_0px_0px_rgba(15,23,42,1)] active:translate-y-1 active:shadow-none transition-all"
                >
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 py-4 px-6 rounded-xl font-black uppercase tracking-widest text-sm text-white bg-slate-900 border-4 border-slate-900 shadow-[6px_6px_0px_0px_rgba(220,38,38,1)] hover:-translate-y-1 hover:shadow-[8px_8px_0px_0px_rgba(220,38,38,1)] active:translate-y-1 active:shadow-none transition-all"
                >
                  <span className="text-xl">📊</span>
                  View Dashboard
                </button>
